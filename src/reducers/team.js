...
export default function(state = initialState, action) {
  switch (action.type) {
    ...
    case "UPDATE_APPLICATION_SUCCESS":
      const appList = state.applications.filter(
        a => a.id !== action.response.id
      );
    ...
    case "UPDATE_ENVIRONMENT_SUCCESS":
      const envList = state.environments.filter(
    ...
    case "RESERVATION_CREATED":
      return {
        ...state,
        reservations: [...state.reservations, action.message]
      };
    ...
    case "CREATE_TEAM_APPLICATION_SUCCESS":
      return {
        ...state,
        applications: [action.response, ...state.applications],
    ...
    case "CREATE_TEAM_ENVIRONMENT_SUCCESS":
      return {
        ...state,
        environments: [action.response, ...state.environments],
